...
RezzHost.sendMessage(m.chat, {text: teks, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://telegra.ph/file/490ab1eea92232fc06e68.jpg", title: " 🎮  𝗚 𝗔 𝗠 𝗘 - 𝗧 𝗘 𝗕 𝗔 𝗞 - 𝗕 𝗢 𝗢 𝗠  🎮", body: null, renderLargerThumbnail: true, sourceUrl: null, mediaType: 1}}}, {quoted: kalgans}).then(() => {
...
if (global.onlypc) {
        	if (command&!m.isGroup){
	         return reply(`WAYSGANZ - MD dalam mode private, gunakan di private chat!`)
	     }
	}
//=================================================//
if (!RezzHost.public) {
...
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m WaysMc \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
            }
//=================================================//
...
await RezzHost.sendMessage(m.chat, { react: { text: "✅️",key: m.key,}
})
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 subtitle: author,
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: `${thumbnail}` } }, { upload: RezzHost.waUploadToServer }))
 }),
...
teksooo += `\n*Total : ${owner.length}*`
RezzHost.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": owner } })
break
...
${tesksesudahsendpay}
`
RezzHost.sendMessage(m.chat, {image: {url: global.qris}, caption: teks}, {quoted: kalgans})
}
break
...
await RezzHost.groupUpdateDescription(from, text).then((res)).catch((err) => reply(jsonformat(err)))
}
break
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"Enable\",\"id\":\".Wayshostchatchange enable\"}"
},
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"Disable\",\"id\":\".Wayshostchatchange disable\"}"
},
 ],
 })
 })
...
if (!db.data.chats[m.chat].RezzHost) return reply(`it's deactivated`)
...
await RezzHost.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
...
if (m.chat in RezzHost.casino) return reply('Masih Ada Yang Melakukan Casino Disini, Tunggu Sampai Selesai!!')
...
akunlo = "https://telegra.ph/file/490ab1eea92232fc06e68.jpg" 
if (!u) return
...
○
└──────────⁠─────────`
RezzHost.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: m })
...
RezzHost.sendList(m.chat, `Page: ${res.meta.pagination.current_page}/${res.meta.pagination.total_pages}`, "Powered By WaysMd", {
...
RezzHost.sendList(m.chat, messageText, "Powered By WaysMc", {
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 isForwarded: true, 
 forwardedNewsletterMessageInfo: {
 newsletterJid: '120363309257397952@newsletter',
 newsletterName: 'Powered By WaysDev', 
 serverMessageId: -1
},
 businessMessageForwardInfo: { businessOwnerJid: RezzHost.decodeJid(RezzHost.user.id) },
 }, 
 ...
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/490ab1eea92232fc06e68.jpg" } }, { upload: RezzHost.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
 buttons: [ 
 {
